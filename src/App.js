  ...
  const MainApp = () => (
    <div className="min-h-screen bg-orange-50 flex flex-col">
      <nav className="bg-orange-600 text-white px-6 py-4 flex justify-between items-center shadow-md">
        <ul className="flex space-x-4">
          <li>
            <a
              href="#"
              className="px-4 py-2 rounded-full font-semibold transition-colors duration-200 hover:bg-orange-700 bg-orange-100 text-orange-800 focus:outline-none"
            >
              Home
            </a>
          </li>
      ...
      <main className="flex-1 p-8">
        <h1 className="text-4xl font-extrabold text-center mb-8 text-orange-700 drop-shadow">
          MERN To-Do App
        </h1>
        <form
          onSubmit={(e) => {
        ...
        >
          ...
          <button
            type="submit"
            className="px-6 py-2 bg-orange-600 hover:bg-orange-700 text-white font-bold rounded-lg transition-colors duration-200"
          >
            Add
          </button>
        </form>
      ...
      <footer className="bg-orange-600 text-white p-4 mt-auto text-center shadow-inner">
        © 2025 Your To-Do App
      </footer>
    </div>
  );
